package domain.repgen.smn_configuracion.smn_nivel_distribucion;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("niv_fecha_registro_ini");
			if (d != null)
			{
		...
		d = rs.getString("niv_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("niv_fecha_registro_fin");
			if (d != null)
			{
