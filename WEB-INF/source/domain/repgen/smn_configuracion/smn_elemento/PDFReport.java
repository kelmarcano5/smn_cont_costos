package domain.repgen.smn_configuracion.smn_elemento;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("ele_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("ele_fecha_registro_ini");
			if (d != null)
			{
		...
		d = rs.getString("ele_descripcion");
			if (d != null)
			{
			name  = "b_description";
