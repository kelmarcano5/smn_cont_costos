package domain.repgen.smn_configuracion.smn_funcion_centro;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("fun_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("fun_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("fun_fecha_registro_ini");
			if (d != null)
			{
