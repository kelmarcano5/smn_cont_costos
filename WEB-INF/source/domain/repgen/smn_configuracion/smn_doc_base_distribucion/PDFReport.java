package domain.repgen.smn_configuracion.smn_doc_base_distribucion;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("dbd_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("dbd_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("dbd_fecha_registro_ini");
			if (d != null)
			{
