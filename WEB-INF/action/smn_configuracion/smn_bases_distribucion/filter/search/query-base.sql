select
	...
	nvc.niv_descripcion as smn_nivel_distribucion_id_combo,
	bdi.bdi_tipo_distribucion,
	cum.cum_codigo as smn_cuenta_mayor_rf_combo,
	modc.mcc_descripcion_comprobante as smn_modelo_comprobante_rf_combo,
	cri.cdi_descripcion as smn_criterio_distribucion_id_combo,
	bdi.bdi_estatus,
...
where
	smn_bases_distribucion_id is not null
	${filter}
order by
